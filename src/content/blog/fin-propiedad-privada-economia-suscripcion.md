...
video:
  ...
  thumbnailUrl: "https://i.ytimg.com/vi/Ez4hvjrSlEc/maxresdefault.jpg"
  duration: "PT12M48.018S"
  uploadDate: "2026-02-23T15:27:19Z"
  chapters:
    - name: "¿Está desapareciendo la propiedad privada?"
      startOffset: 0
      endOffset: 101
    - name: "¿Qué es la servitización y por qué crea cuotas eternas?"
      startOffset: 101
      endOffset: 251
    - name: "¿Qué relación hay entre el Gran Reinicio y el Efecto Cantillon?"
      startOffset: 251
      endOffset: 408
    - name: "¿Estamos entrando en un Feudalismo Digital con CBDCs?"
      startOffset: 408
      endOffset: 571
    - name: "¿Cómo proteger tu patrimonio ante la economía del acceso?"
      startOffset: 571
      endOffset: 0
---

<div class="bg-zinc-50 border border-zinc-200 rounded-2xl p-8 mb-10">
  <h3 class="text-xl font-bold text-zinc-900 mb-4">💡 Realidades de la economía moderna</h3>
  <ul class="space-y-4 text-zinc-700">
    <li class="flex items-start gap-2">
      <span class="text-blue-600 mt-1">✔</span>
      <span><strong>Economía del acceso:</strong> El desplazamiento global desde la propiedad hacia el uso temporal de bienes.</span>
    </li>
    <li class="flex items-start gap-2">
      <span class="text-blue-600 mt-1">✔</span>
      <span><strong>Servitización:</strong> La transformación de productos tradicionales en modelos de servicios recurrentes.</span>
    </li>
    <li class="flex items-start gap-2">
      <span class="text-blue-600 mt-1">✔</span>
      <span><strong>Opcionalidad:</strong> Cómo las suscripciones constantes erosionan la flexibilidad financiera del hogar.</span>
    </li>
    <li class="flex items-start gap-2">
      <span class="text-blue-600 mt-1">✔</span>
      <span><strong>Efecto Cantillon:</strong> El mecanismo que amplifica la desigualdad según la proximidad al origen del dinero.</span>
    </li>
    <li class="flex items-start gap-2">
      <span class="text-blue-600 mt-1">✔</span>
      <span><strong>Resiliencia:</strong> La necesidad crítica de activos reales y soberanía estratégica en tu patrimonio.</span>
    </li>
  </ul>
</div>
...
<div class="iframe-container" style="position: relative; width: 100%; height: 0; padding-bottom: 56.25%; overflow: hidden;">
  <iframe width="560" height="315" src="https://www.youtube.com/embed/Ez4hvjrSlEc?si=LjHBBDbNjIBT9WQE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: none;"></iframe>
</div>
