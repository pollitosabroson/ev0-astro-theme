...
video:
  embedUrl: "https://www.youtube.com/embed/JGASd3tRnj0"
  thumbnailUrl: "https://i.ytimg.com/vi/JGASd3tRnj0/maxresdefault.jpg"
  uploadDate: "2026-07-08T20:43:12Z"
  chapters:
    - name: "La empresa que nadie puede comprar"
      startOffset: 0
      endOffset: 152
    - name: "Tres momentos que construyeron el imperio"
      startOffset: 152
      endOffset: 440
    - name: "La estructura que ninguna cotizada puede copiar"
      startOffset: 440
      endOffset: 638
    - name: "El truco: menos producto, más beneficio"
      startOffset: 638
      endOffset: 780
    - name: "Por qué un Rolex NO es una inversión (5 razones)"
      startOffset: 780
      endOffset: 929
    - name: "Las 3 lecciones que aplican a tu cartera"
      startOffset: 929
      endOffset: 1081
    - name: "Lo que sobrevive al tiempo casi nunca es lo que más brilla"
      startOffset: 1081
      endOffset: 0
---
...
| --- | --- | --- |
| Liquidez | Baja (semanas para vender) | Alta (vendes al instante) |
| Comisiones al vender | 10-20 % | Mínimas |
| Volatilidad | Alta (cayó 30-40 % en 2022-2024) | Variable, pero con histórico al alza |
| Acceso | Listas de espera, condiciones | Abierto a cualquiera |

La trampa es la de siempre en este canal: **confundir lo que queremos con lo que nos conviene**. Cuando algo parece demasiado bueno para ser verdad, casi siempre es una verdad a medias. Si te interesa el otro lado de esta moneda, te dejo mi reflexión sobre el [coste de oportunidad](/blog/comprar-coche-mala-inversion/).
...
2. **La estructura es destino.** La fundación de 1945 mantiene a Rolex intacta ochenta años después. En tus finanzas, lo estructural —cuánto ahorras, dónde inviertes, si tienes un [fondo de emergencia](/blog/fondo-emergencia-inteligente-2026/), en qué te endeudas— pesa mucho más que qué acción compras este mes.
3. **El valor real es el que sobrevive al tiempo.** Rolex lleva más de un siglo construyendo confianza, y por eso puede vender un reloj al doble de su precio. La riqueza de verdad no llega con un pelotazo: llega con constancia y decisiones repetidas durante años. Como el [interés compuesto](/blog/interes-simple-vs-interes-compuesto/).
...
📺 [Ver el análisis completo en mi canal de YouTube](https://www.youtube.com/watch?v=JGASd3tRnj0])

<div class="iframe-container" style="position: relative; width: 100%; height: 0; padding-bottom: 56.25%; overflow: hidden;">
  <iframe width="560" height="315" src="https://www.youtube.com/embed/JGASd3tRnj0?si=ch_SL3ujQMWozJRM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: none;"></iframe>
</div>
